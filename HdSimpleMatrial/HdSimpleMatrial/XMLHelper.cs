...
DevExpress.XtraEditors.XtraMessageBox.Show("XML文档创建成功:" + xmlFileName);
...
DevExpress.XtraEditors.XtraMessageBox.Show("XML节点添加或更新成功:" + isSuccess.ToString());
...
DevExpress.XtraEditors.XtraMessageBox.Show("XML属性添加或更新成功:" + isSuccess.ToString());
...
DevExpress.XtraEditors.XtraMessageBox.Show("XML节点删除成功:" + isSuccess.ToString());
...
DevExpress.XtraEditors.XtraMessageBox.Show("XML属性删除成功:" + isSuccess.ToString());
...
DevExpress.XtraEditors.XtraMessageBox.Show("XML节点中所有子节点有:" + strAllNode);
